  ...
  return (
    <>
      <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left md:mb-0 items-center text-center z-2">
        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Grayash</h1>
        <p className="mb-8 leading-relaxed">
          ...
          7th & 8th Co-Organizer <br />
        </p>
        <Link href="https://github.com/grayashh" target="_blank">
          <a className="btn-project gap-2 items-center">
